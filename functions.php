...
function enqueue_assets() {
	...
	\wp_enqueue_script(
		...
		\get_stylesheet_directory_uri() . '/develop/js/keyboard-dropdown' . $suffix,
		[ 'jquery' ],
		\CHILD_THEME_VERSION,
		true
	);
	...
	\wp_enqueue_script(
		...
		\get_stylesheet_directory_uri() . '/develop/js/responsive-menu' . $suffix,
		[ 'jquery' ],
		'1.0.0', true
	);
	...
	\wp_enqueue_script(
		...
		\get_stylesheet_directory_uri() . '/develop/js/responsive-menu-args' . $suffix,
		[ 'utility-pro-responsive-menu' ],
		\CHILD_THEME_VERSION,
		true
	);
	...
	\wp_enqueue_script(
		...
		\get_stylesheet_directory_uri() . '/develop/js/backstretch' . $suffix,
		[ 'jquery' ],
		'2.0.1',
		true
	);
