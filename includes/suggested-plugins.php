 ...
 */
function utility_pro_register_required_plugins() {
	...
	$config = array(
		...
		'strings'          => array(
			...
			'installing'                      => _x( 'Installing Plugin: %s', '%1$s = plugin name', 'utility-pro' ),
			...
			'complete'                        => _x( 'All plugins installed and activated successfully. %s', '%1$s = dashboard link', 'utility-pro' ),
